        ...
        <div className="flex flex-col gap-6 items-center mt-10 lg:flex-row lg:items-end lg:justify-center">
          {pricingTiers.map((tier, index) => (
            ...
            <div className={ twMerge("card",tier.inverse === true && ("border-black bg-black text-white"))}>
              ...
              className="bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2FF,#3BFFFF,#DD7DDF,#E1CD86,#BBCB92,#71C2FF,#3BFFFF)] [background-size:200%] text-transparent bg-clip-text font-medium">
              Popular
              </motion.span>
              </div>
              )}
